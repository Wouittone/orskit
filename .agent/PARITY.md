...
| Propagation | Two-body/Keplerian propagation | Partial | Analytic orbit scenarios; conservation/error budget | Analytical signed-duration propagation for elliptic `KeplerianState`; circular/invariant/reverse-time tests and Orekit 13.1.6 plus Lox 0.1.0-alpha.39 Cartesian comparisons pass; Cartesian/universal-variable, other conics, Nyx comparison, events, and ephemerides pending |
