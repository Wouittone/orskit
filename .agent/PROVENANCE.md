...
| Orbit state representations | [NASA GMAT Mathematical Specifications (2007)](https://ntrs.nasa.gov/citations/20080031744), [NAIF SPICE `CONICS`](https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/FORTRAN/spicelib/conics.html), and [Orekit 12.0.2 `EquinoctialOrbit` API](https://www.orekit.org/site-orekit-12.0.2/apidocs/org/orekit/orbits/EquinoctialOrbit.html) | US Government technical/API documentation; Orekit public behavior documentation | State/element conventions, valid regimes, and independent analytic behavior only | `crates/core/src/state.rs`; `.agent/decisions/0004-trait-based-state-representations.md` |
| Elliptic two-body propagation | [NASA GMAT Mathematical Specifications (2007)](https://ntrs.nasa.gov/citations/20080031744), [Orekit 13.1.6 `KeplerianPropagator`](https://www.orekit.org/static/apidocs/org/orekit/propagation/analytical/KeplerianPropagator.html), and [Lox 0.1.0-alpha.39 `Vallado`](https://docs.rs/lox-space/0.1.0-alpha.39/lox_space/prelude/struct.Vallado.html) | US Government equations; Apache-2.0 and MPL-2.0 public API/black-box behavior | Mean-anomaly evolution and elliptic Kepler equation; independent Cartesian output only. Orekit and Lox outputs recorded with their explicit gravitational parameters. Nyx deliberately not consulted under project policy | `crates/dynamics/src/two_body.rs`; `.agent/references/two-body`; ADR-0007 |
| Force and torque capability inventory | [Orekit 13.1.6 force packages](https://www.orekit.org/site-orekit-latest/apidocs/org/orekit/forces/package-summary.html), [IERS Conventions 2010 Chapter 6](https://iers-conventions.obspm.fr/content/chapter6/icc6.pdf), [NASA GMAT force-model documentation](https://documentation.help/GMAT/Propagator.html), and [NASA attitude-control survey](https://s3vi.ndc.nasa.gov/ssri-kb/static/resources/A%20Brief%20Survey%20of%20Attitude%20Control%20Systems%20for%20Small%20Satellites%20u.pdf) | Public behavior/capability documentation, public standards, and US Government technical documentation | Capability names, model-family boundaries, tide-convention warning, and disturbance-torque categories only; no implementation material | `.agent/FORCE_MODELS.md` |
